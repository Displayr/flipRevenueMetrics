...
test_that("Checking calculations",
          {
              ...
              s <- RevenueMetric(FUN = "CustomerChurn", output = out, d$Value, from = d$From, to = d$To, 
              ...
              id.m <- data.frame(id = d$Name[c(1)],
                                 id.to = d$Name[c(7)])
              s1 <- RevenueMetric(FUN = "CustomerChurn", output =out, d$Value, from = d$From, to = d$To, #end = as.Date("2020/06/30"), 
                                  id = d$Name, by = by, mergers = id.m)
              ...
              q <- q.invoice.lines
              s <- RevenueMetric(FUN = "CustomerChurn", output = out, q$AUD, from = q$ValidFrom, to = q$ValidTo, 
              ...
              s1 <- RevenueMetric(FUN = "CustomerChurn", output = out, q$AUD, from = q$ValidFrom, to = q$ValidTo, 
